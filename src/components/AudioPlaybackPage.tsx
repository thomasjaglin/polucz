      ...
      <AnimatePresence mode="wait">
        {availableCount === 0 ? (
          ...
          >
            ...
            {showControls && (
              <div className="absolute bottom-2 right-0 z-10" style={{ width: 124, height: 178 }}>
                {/* Controls fan out on an arc around the play button (thumb zone):
                    repeat top · speed upper-left · previous lower-left · next
                    bottom · play centre-right. Positioned absolutely. */}
                ...
                {/* Skip to previous card — lower-left */}
                <button
