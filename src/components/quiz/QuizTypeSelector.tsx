  ...
  return (
    <div className="flex flex-col gap-4 pt-2">
      ...
      <button
        ...
        disabled={!hasEnough}
        className="w-full rounded-[24px] border border-white/10 bg-white/[0.03] p-5 text-left transition-all hover:bg-white/[0.06] active:scale-[0.98] disabled:pointer-events-none disabled:opacity-35"
      >
