...
export interface ReviewState {
  ...
  conquered?: boolean
  // Consecutive right-swipes ("easy"). Incremented on a right-swipe, reset to 0
  // by a left-swipe or "Again". Drives the flashcard "strong" grade so strength
  // reflects actually getting the word right recently, not time in rotation.
